...
git branch -M main
git remote add origin git@github.com:<YOUR-USER>/pi-completion-workflow.git
...
If the package name is available:
...
If you switch to a scoped public package name such as `@your-scope/pi-completion-workflow`, publish with:
...
# or
pi install npm:@your-scope/pi-completion-workflow
```
