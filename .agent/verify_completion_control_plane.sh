...
for file in   .agent/README.md   .agent/mission.md   .agent/profile.json   .agent/verify_completion_stop.sh   .agent/verify_completion_control_plane.sh   .agent/state.json   .agent/plan.json   .agent/active-slice.json   .agent/verification-evidence.json; do
